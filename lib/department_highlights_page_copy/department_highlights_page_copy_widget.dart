...
class DepartmentHighlightsPageCopyWidget extends StatefulWidget {
  const DepartmentHighlightsPageCopyWidget({
    Key key,
    this.departmentId,
    this.displayName,
  }) : super(key: key);
  ...
  @override
  _DepartmentHighlightsPageCopyWidgetState createState() =>
      _DepartmentHighlightsPageCopyWidgetState();
}

class _DepartmentHighlightsPageCopyWidgetState
    extends State<DepartmentHighlightsPageCopyWidget> {
